...
public class GeneratorImpl implements Generator {
    ...
    public void execute() throws IOException, SQLException, TemplateException {
        ...
        write(files.get(2), fm.getTmpViewConten(), map, cnfg, fm);
        write(files.get(3), fm.getTmpViewForm(), map, cnfg, fm);
        write(files.get(4), fm.getTmpJSContent(), map, cnfg, fm);
        write(files.get(5), fm.getTmpJSForm(), map, cnfg, fm);
    }
    ...
    private Map<?, ?> getParam(FileManager fm) throws SQLException {
        ...
        map.put("controllerModel", NameUtils.getNameForModelController(fm.getModule()));
