...
public class DBTable {
    ...
    public DBTable(String username, String password, String database, String table) throws SQLException {
        ...
        while (res.next()) {
            ...
            td.setField(NameUtils.camelForField(res.getString(1)));
            td.setFieldJavaSetGet(NameUtils.camelForFieldJavaSetGet(res.getString(1)));
    ...
    private Connection getConnection(String database, String username, String password) throws SQLException {
        return DriverManager.getConnection("jdbc:mariadb://192.168.64.2:3306/" + database + "?user=" + username + "&password=" + password);
    }
}
