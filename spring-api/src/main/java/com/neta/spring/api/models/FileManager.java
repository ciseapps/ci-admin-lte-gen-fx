...
import com.neta.spring.api.commons.NameUtils;
...
//    private String tmpJSContent;
    ...
    public FileManager(String baseProjectPath, String baseTemplatePath, String prefix, String module) {
        ...
        // base folder
        this.baseModules = baseProjectPath + sp + "java" + sp + "com" + sp + "neta" + sp + "spring" + sp + "api" + sp + "modules";//
        this.baseServices = baseProjectPath + sp + "java" + sp + "com" + sp + "neta" + sp + "spring" + sp + "api";//
        this.baseDaos = baseProjectPath + sp + "java" + sp + "com" + sp + "neta" + sp + "spring" + sp + "api" + sp + "repositories";//
        ...
        this.models = baseDaos + sp + "dao";
        this.repo = baseDaos + sp + "repository";
        this.service = baseServices + sp + "services";
        // template
